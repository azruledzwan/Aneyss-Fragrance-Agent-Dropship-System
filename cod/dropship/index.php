  ...
  <div class="wrap-content">
		<div class="container">
			<div class="row">
							<div class="col-md-12 text-left">
								Log Masuk Sebagai<b> <?php echo $nama; ?> | <?php echo $level; ?></b>
							</div>
			</div>
					...
					<nav class="navbar navbar-inverse">
							...
							<div class="collapse navbar-collapse" id="myNavbar">
								<ul class="nav navbar-nav navbar-right">
									<li ><a href="index.php?menu=bakulbelian" ><b>UTAMA</b></a></li>
                  <li ><a href="../index.php" ><b>LOG KELUAR</b></a></li>
								</ul>
							</div>
					</nav>
				</div>
        ...
        <div class="col-md-12">
            <div class="panel panel-default text-center" style="min-height: 500px">
              ...
              BAKUL PEMBELIAN  <b>  <?php echo $nama; ?></b>
              </div>
