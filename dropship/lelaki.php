<div class="row">
	<?php
		...
		$bil = 1;
		$sql = "SELECT * FROM produk WHERE kategori = 'lelaki' AND isipadu = '30ml'";
		...
		<div class="col-md-4 text-center table-list-search">
			<div class="thumbnail">
				...
				<div class="caption">
					...
					<h5><b>RM <?php echo $rowharga['dropship30ml']; ?></b></h5>
		...
		$rowharga=$conn->query($sql)->fetch_assoc();
		$bil = 1;
		$sql = "SELECT * FROM produk WHERE kategori = 'lelaki' AND isipadu = '5ml'";
		$result = $conn->query($sql);
		while($row = $result->fetch_assoc()){
			?>
		<div class="col-md-4 text-center table-list-search">
			<div class="thumbnail">
				...
				<div class="caption">
					<h5><b style="color: purple"><?php echo $row['namaproduk']; ?></b></h5>
					<h5><b>RM <?php echo $rowharga['stokis5ml']; ?></b></h5>
					<h6><?php echo $row['aroma1']; ?>,<?php echo $row['aroma2']; ?>,<?php echo $row['aroma3']; ?>,<?php echo $row['aroma4']; ?>,<?php echo $row['aroma5']; ?>,<?php echo $row['aroma6']; ?></h6><br>
