			...
			<div class="panel-heading text-center">
				...
				<div class="panel-body">
					<div>
						...
						?>
						<form class="form-horizontal form-left" method="post" action="dropship-simpan.php" >
							<input type="hidden" name="idpakej" value="0">
							 <input type="hidden" name="level" value="dropship">
							 <input type="hidden" name="status" value="baru">
							 <input type="hidden" name="resit" value="0">
							 <input type="hidden" name="pakej" value="Pakej <?php echo $row['harga']; ?>">
							<fieldset>
							 <!-- Text input-->
							<center><label>PAKEJ DIPILIH : PAKEJ RM <?php echo $row['harga']; ?></label></center><br>
							...
							<!-- Text input-->
								<div class="form-group">
									...
									<div class="col-md-6">
									<input  name="notelefon" type="text" placeholder="nombor telefon" class="form-control input-md" maxlength="11" onkeypress='return event.charCode >= 48 && event.charCode <= 57' >
									</div>
								</div>
							...
							<div class="form-group">
							  ...
							  <div class="col-md-5">
								<button id="" name="" class="btn btn-success btn-block"><b>HANTAR</b></button>
							  </div>
							</div>
